...
- [Main Entry Point](modules/main-entrypoint) — CLI commands
- [HF Sync](modules/hf-sync) — HF Hub sync details
- [GPU Acceleration](infrastructure/gpu-acceleration) — Hardware requirements
- [Data Collection](pipeline/data-collection) — Collection pipeline
- [Training Pipeline](pipeline/training-pipeline) — Training pipeline
