...
aliases: [Sentiment, Lexicon Scoring, News Sentiment]
tags: [analysis, sentiment, nlp, lexicon]
created: 2026-04-12
---
...
Sentiment scores are computed during [[nlp-enrichment]] and used in:

1. **Monthly aggregation**: Average sentiment per country-cluster-month
2. **Lead-lag analysis**: Sentiment as a predictor of [[visa-data|visa issuances]] at 0–6 month lags
3. **Panel features**: Sentiment enters [[panel-construction]] alongside event counts and exchange rates
...
- [[nlp-enrichment]] — Pipeline context
- [[event-clustering]] — How articles are grouped before sentiment scoring
- [[lead-lag-analysis]] — How sentiment feeds into correlation analysis
- [[event-visa-findings]] — What sentiment analysis revealed
