...
The [Lead-Lag Analysis](analysis/lead-lag-analysis) tests hundreds of (country, signal, lag) combinations:
...
- [Lead-Lag Analysis](analysis/lead-lag-analysis) — Where the corrections are applied
- [Event-Visa Findings](findings/event-visa-findings) — Results after correction
- [Exchange Rate Findings](findings/exchange-rate-findings) — Exchange rate results
- [Cross-Correlation Analysis](analysis/cross-correlation) — Trends analysis results
- [Glossary](glossary) — FDR definition
