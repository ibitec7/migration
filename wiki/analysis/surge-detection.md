...
aliases: [Surge, Spike Detection, Surge Threshold]
tags: [analysis, surge, threshold, detection]
created: 2026-04-12
---
...
Used in [[lead-lag-analysis]] and [[event-visa-findings]]:
...
Used in [[surge-joint-loss]] and [[model-performance]] evaluation:
...
A separate definition for [[exchange-rates|exchange rate]] volatility:
...
- [[surge-joint-loss]] — How surge labels train the LSTM
- [[lead-lag-analysis]] — Where analysis surges are used
- [[model-performance]] — Surge detection evaluation results
- [[horizon-aware-ensemble]] — Production surge flagging
