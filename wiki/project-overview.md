...
aliases: [Overview, About, Research Questions]
tags: [overview, research, methodology]
created: 2026-04-12
---
...
1. **Collect** four data streams at monthly cadence → [[data-collection]]
   - [[visa-data]] and [[encounter-data]] as ground truth
   - [[google-news]], [[google-trends]], [[exchange-rates]] as predictive signals
2. **Process** raw data into model-ready panels → [[data-processing]], [[panel-construction]]
3. **Enrich** news articles with NLP → [[nlp-enrichment]]
4. **Analyze** lead-lag relationships → [[lead-lag-analysis]], [[cross-correlation]]
5. **Train** four ML architectures → [[training-pipeline]]
6. **Ensemble** predictions with horizon-aware weighting → [[horizon-aware-ensemble]]
7. **Evaluate** with out-of-time validation → [[model-performance]]
...
- **All three modalities contribute**, but no single one is sufficient → [[event-visa-findings]]
...
- [[reproducibility]] — How to set up and run the project
- [[model-performance]] — Detailed performance tables
