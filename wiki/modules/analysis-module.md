...
- [Sentiment Analysis](analysis/sentiment-analysis) — Scoring approach
- [Event Clustering](analysis/event-clustering) — HDBSCAN + labeling
- [Cross-Correlation Analysis](analysis/cross-correlation) — CCF/VAR analysis
- [Processing Module](modules/processing-module) — Upstream data provider
- [Models Module](modules/models-module) — Downstream model training
