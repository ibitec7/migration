...
The [Models Module](modules/models-module) (`surge_model.py`) reshapes the flat lag vector into sequences for LSTM/Transformer:
...
- [Panel Construction](pipeline/panel-construction) — Pipeline context
- [Data Processing](pipeline/data-processing) — Previous stage
- [Training Pipeline](pipeline/training-pipeline) — Next stage
