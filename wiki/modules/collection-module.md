...
- [Data Collection](pipeline/data-collection) — Pipeline context
- [News Scraper](modules/news-scraper) — Deep dive on news.py
- [HF Sync](modules/hf-sync) — Deep dive on hf_sync.py
- [Main Entry Point](modules/main-entrypoint) — CLI that invokes collection
- [Processing Module](modules/processing-module) — Downstream consumer
