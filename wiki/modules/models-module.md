...
- [Training Pipeline](pipeline/training-pipeline) — Pipeline context
- [Inference Pipeline](pipeline/inference-pipeline) — Production flow
- [Random Forest](models/random-forest), [LSTM](models/lstm), [Transformer](models/transformer) — Architecture details
- [Horizon-Aware Ensemble](models/horizon-aware-ensemble) — Ensemble weights
- [SurgeJointLoss](models/surge-joint-loss) — Custom loss function
- [TensorRT Engines](modules/tensorrt-engines) — Engine deep dive
