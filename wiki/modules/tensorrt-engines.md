...
aliases: [TRT Engines, GPU Inference Engines, TensorRT]
tags: [module, deep-dive, tensorrt, gpu, inference]
created: 2026-04-12
---
...
Used by `src/models/embedding.py` → see [[jina-v5-embeddings]].
...
Used by `src/processing/summarize.py` → see [[flan-t5-summarization]].
...
Used by `src/analysis/label_events_with_led.py` → see [[event-clustering]].
...
- [[jina-v5-embeddings]] — Embedding model context
- [[flan-t5-summarization]] — Labeling model context
- [[gpu-acceleration]] — Broader GPU infrastructure
- [[models-module]] — Full source code reference
