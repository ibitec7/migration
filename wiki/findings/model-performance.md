...
aliases: [Results, Benchmarking, Evaluation, Model Results]
tags: [findings, performance, evaluation, f1, rmse]
created: 2026-04-12
---
...
|-------|--------|--------|--------|---------|
| [[random-forest\|RF]] | **0.97** | 0.91 | 0.82 | Short horizons |
| [[lstm\|LSTM]] | 0.95 | 0.92 | 0.84 | Mid horizons |
| [[transformer\|Transformer]] | 0.93 | 0.92 | **0.87** | Long horizons |
...
- **LSTM** has the fewest false alarms (highest precision at Lead 1) thanks to [[surge-joint-loss]]
